...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.sortByPrice("Price (High > Low)");
        ...
        Assert.assertEquals(actualUpdatedMessage, expectedUpdatedMessage, "Incorrect message displayed!");

        //2.14 Verify the Total £737.45.00
        String actualTotalPrice = shoppingCartPage.verifyTotalPrice();
        String expectedTotalPrice = "£737.45";
        Assert.assertEquals(actualTotalPrice, expectedTotalPrice, "Incorrect message displayed!");
        ...
        Assert.assertEquals(actualCheckOutText, expectedCheckOutText, "Incorrect message displayed!");
        ...
        checkOutPage.fillAllMandatoryField("Peter", "Sam", "petersam123@gmail.com", "0755345786",
                "Pond street", "Watford", "WD19 6DS", "United Kingdom", "Aberdeen");
